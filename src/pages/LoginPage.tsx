...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center gradient-mesh bg-[#06060b] px-4 relative overflow-hidden">
      {/* Ambient glow orbs */}
      ...
      >
        <div className="glass-strong rounded-2xl p-8 md:p-10 glow-blue">
          ...
          >
            ...
            <p className="text-gray-400 text-sm">Welcome back! Sign in to continue learning.</p>
          </motion.div>
